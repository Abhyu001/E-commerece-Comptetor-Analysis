...
st.dataframe(product_data.tail(5), width=800)  # Adjusting table width for better readability
...
recommendations = generate_strategy_recommendation(selected_product, product_data, sentiments if not product_reviews.empty else "No reviews available")
